...
make_device! {
    ...
    #[bit(5, RO, rro::I2C_STATUS_OFFSET)]
    master_busy,
    ...
    /// - 0: Not Full
    /// - 1: Full
    #[bit(4, RO, rro::I2C_STATUS_OFFSET)]
    transmit_fifo_full,
    ...
    /// - 0: Not Empty
    /// - 1: Empty
    #[bit(3, RO, rro::I2C_STATUS_OFFSET)]
    transmit_fifo_empty,
    ...
    /// - 0: Not Full
    /// - 1: Full
    #[bit(2, RO, rro::I2C_STATUS_OFFSET)]
    receive_fifo_full,
    ...
    /// - 0: Not Empty
    /// - 1: Empty
    #[bit(1, RO, rro::I2C_STATUS_OFFSET)]
    receive_fifo_empty,
    ...
    /// - 0: I2C bus is idle
    /// - 1: I2C bus is busy
    #[bit(0, RO, rro::I2C_STATUS_OFFSET)]
    transaction_active,
    ...
    /// - 0: No Address Match
    /// - 1: Address Match
    #[bit(23, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    /// - 0: No Address Match
    /// - 1: Address Match
    #[bit(22, RW1C, rro::I2C_INTFL0_OFFSET)]
    slave_read_addr_match_interrupt,

    /// MAMI Interrupt Flag
    #[bit(16, RW1C, rro::I2C_INTFL0_OFFSET)]
    mami_interrupt_flag,
    ...
    #[bit(15, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(14, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(13, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(12, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(11, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(10, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    /// - 0: Normal Operation
    /// - 1: Timeout occurred
    #[bit(9, RW1C, rro::I2C_INTFL0_OFFSET)]
    timeout_error_flag,
    ...
    #[bit(8, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    /// - 0: Normal Operation
    /// - 1: ACK Received
    #[bit(7, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(6, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(5, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(4, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(3, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(2, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(1, RW1C, rro::I2C_INTFL0_OFFSET)]
    irxm_interrupt_flag,
    ...
    #[bit(0, RW1C, rro::I2C_INTFL0_OFFSET)]
    ...
    #[bit(23, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(22, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(16, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(15, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(14, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(13, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(12, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(11, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(10, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(9, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(8, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(7, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(6, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(5, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(4, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(3, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(2, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(1, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(0, RW, rro::I2C_INTEN0_OFFSET)]
    ...
    #[bit(2, RW1C, rro::I2C_INTFL1_OFFSET)]
    ...
    #[bit(1, RW1C, rro::I2C_INTFL1_OFFSET)]
    ...
    #[bit(0, RW1C, rro::I2C_INTFL1_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(2, RW, rro::I2C_INTEN1_OFFSET)]
    ...
    /// - 0: Interrupts Disabled
    /// - 1: Interrupts Enabled
    #[bit(1, RW, rro::I2C_INTEN1_OFFSET)]
    ...
    #[bit(8..=11, RW, rro::I2C_RXCTRL0_OFFSET)]
    receive_fifo_threshold_level,
    ...
    #[bit(7, RW1O, rro::I2C_RXCTRL0_OFFSET)]
    flush_receive_fifo,
    ...
    /// - 1: NACK the address
    #[bit(0, RW, rro::I2C_RXCTRL0_OFFSET)]
    ...
    ///  ...
    /// - 8: 8 bytes
    #[bit(8..=11, RO, rro::I2C_RXCTRL1_OFFSET)]
    ...
    #[bit(0..=7, RW, rro::I2C_RXCTRL1_OFFSET)]
    ...
    #[bit(8..=11, RW, rro::I2C_TXCTRL0_OFFSET)]
    transmit_fifo_threshold_level,
    ...
    #[bit(7, RW1O, rro::I2C_TXCTRL0_OFFSET)]
    transmit_fifo_flush,
    ...
    #[bit(5, RW, rro::I2C_TXCTRL0_OFFSET)]
    ...
    /// - 0: Enabled
    /// - 1: Disabled
    #[bit(4, RW, rro::I2C_TXCTRL0_OFFSET)]
    ...
    /// - 0: Enabled
    /// - 1: Disabled
    #[bit(3, RW, rro::I2C_TXCTRL0_OFFSET)]
    ...
    /// - 0: Enabled
    /// - 1: Disabled
    #[bit(2, RW, rro::I2C_TXCTRL0_OFFSET)]
    ...
    #[bit(1, RW, rro::I2C_TXCTRL0_OFFSET)]
    ...
    #[bit(0, RW, rro::I2C_TXCTRL0_OFFSET)]
    ...
    /// ...
    /// - 8: 8 bytes (FIFO full)
    #[bit(8..=11, RO, rro::I2C_TXCTRL1_OFFSET)]
    transmit_fifo_byte_count,

    /// Transmit FIFO Preload Ready (page 235)
    #[bit(0, RW1O, rro::I2C_TXCTRL1_OFFSET)]
    ...
    #[bit(0..=7, RW, rro::I2C_FIFO_OFFSET)]
    write_fifo_data,
    ...
    #[bit(8..=10, RW, rro::I2C_MSTCTRL_OFFSET)]
    mcode,
    ...
    #[bit(0..=7, RW, rro::I2C_HSCLK_OFFSET)]
    ...
    #[bit(0..=15, RW, rro::I2C_TIMEOUT_OFFSET)]
    ...
    /// - 1: 10-bit addressing
    #[bit(15, RW, rro::I2C_SLAVE_OFFSET)]
    ...
    #[bit(0..=9, RW, rro::I2C_SLAVE_OFFSET)]
    slave_mode_address,
}
